...
[SimpleAuthorization](https://github.com/levifeyd/SimpleAuthorization) | Простая страничка с формой для регистрации и авторизации на сайте| PHP, HTML CSS, SQL(MySQL, bootsrap)| Использовался локальный сервер OpenServer.
